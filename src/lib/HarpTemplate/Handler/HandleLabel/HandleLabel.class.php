 ...
 */
namespace etc\HarpDesignTemplate\components\HandleHtml\HandleInput;

use etc\HarpDesignTemplate\components\HarpFileComponent;

include_once(__DIR__.'/ElementInput.class.php');
...
class HandleInput
{
    ...
    public function __construct(HarpFileComponent $HarpFileComponent)
    {
        ...
        $this->ElementInput= new ElementInput($HarpFileComponent);
    }
