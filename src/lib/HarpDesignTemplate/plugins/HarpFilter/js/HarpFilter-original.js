...
(function ($) {
    $.fn.HarpFilter = function (options) 
    {
     ...
     //   jQuery('head').append('<link rel="stylesheet" type="text/css" href="' + settings.baseUrl + '/HarpFilter/css/HarpFilterDefault.css">');
        ...
        jQuery('.filterField').children().css({ 'min-width': settings.filterFieldMinWidth,'max-width':settings.filterFieldMaxWidth});  
        jQuery('.logicalOperator').children().css({'min-width':settings.logicalOperatorMinWidth,'max-width':settings.logicalOperatorMaxWidth});
        jQuery('.relationalOperator').children().css({ 'min-width': settings.relationalOperatorMinWidth,'max-width': settings.relationalOperatorMaxWidth});
