...
class Show
{
    ...
    [
        ...
        "\033[36m [controller build]  ".PHP_EOL."\033[0m \033[91m build::controller \033[92m{appName}/{moduleName}/{controllerName}\033[093m/{methodName} \033[0m \033[0m".PHP_EOL,
        "\033[36m [model build]       ".PHP_EOL."\033[0m \033[91m build::model \033[92m{appName}/{moduleName}/{modelName}\033[093m/{methodName} \033[0m \033[0m".PHP_EOL,
        ...
        "\033[36m [group build]       ".PHP_EOL."\033[0m \033[91m build::group \033[92m{appName}/{moduleName}/{controllerName}\033[093m/{methodName} \033[0m \033[92m--type={api|app}\033[0m \033[093m--short={shortNameRoute}\033[0m \033[0m".PHP_EOL,
        ...
        "\033[36m [migration exec]   ".PHP_EOL."\033[0m \033[91m db::migrate \033[92m--app={appName}  \033[ \033[093m --name={fileMigrationWithoutExtension} --conn={connName}\033".PHP_EOL,
        "\033[36m [entity db build]    ".PHP_EOL."\033[0m \033[91m db::entity \033[92m{app}/{module}/{entityName} \033[093m--table={nameTable} --conn={connName} \033[0m\033[0m".PHP_EOL,
        "\033[36m [entity build|db]       ".PHP_EOL."\033[0m \033[91m build::entity \033[92m{app}/{module}/{entityName} \033[093m--table={nameTable} --conn={connName}\033[0m\033[0m".PHP_EOL,
